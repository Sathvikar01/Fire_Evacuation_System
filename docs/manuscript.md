...
**PDF:** [`docs/IEEE_Paper.pdf`](IEEE_Paper.pdf) — 7 pages, IEEEtran.
...
| **Partial observability** (r=3 sensing / stale Δt=5 / 50% loss) | **No flip**: A* .991–.994 everywhere; DACO .930–.940; gap Holm p≤.0022 in all regimes |
